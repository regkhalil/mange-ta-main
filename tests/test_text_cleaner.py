...
class TestCleanRecipeData:
    ...
    def test_clean_all_recipe_columns(self):
        ...
        expected_columns = [
            'name_cleaned', 'description_cleaned', 'steps_cleaned',
            'tags_cleaned', 'ingredients_cleaned'
        ]
    ...
    def test_name_title_case(self):
        ...
        df = pd.DataFrame({
            'name': ['mom s chocolate cake recipe']
        })
    ...
    def test_description_sentence_case(self):
        ...
        df = pd.DataFrame({
            'description': ['this is a description. this is another sentence']
        })
    ...
    def test_steps_fast_mode(self):
        ...
        df = pd.DataFrame({
            'steps': ["['step one with france', 'step two with italy']"]
        })
    ...
    def test_ingredients_title_case(self):
        ...
        df = pd.DataFrame({
            'ingredients': ["['fresh basil', 'extra virgin olive oil']"]
        })
...
class TestIntegrationWithDataFrame:
    ...
    def test_full_recipe_cleaning_pipeline(self, sample_dataframe):
        ...
        cleaned_cols = {'name_cleaned', 'description_cleaned', 'steps_cleaned', 
                       'tags_cleaned', 'ingredients_cleaned'}
