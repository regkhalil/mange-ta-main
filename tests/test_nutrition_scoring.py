...
class TestScoreNutritionMainFunction:
    ...
    def test_custom_nutrition_column(self):
        ...
        df = pd.DataFrame({"custom_nutrition": [[300, 15, 10, 500, 20, 5, 45], [200, 8, 5, 300, 15, 3, 25]]})
    ...
    def test_calories_extraction(self):
        ...
        df = pd.DataFrame({"nutrition": [[300, 15, 10, 500, 20, 5, 45], [250, 12, 8, 400, 18, 4, 40], "invalid"]})
    ...
    def test_copy_behavior(self):
        ...
        _result = nutrition_scoring.score_nutrition(df)
...
class TestHealthyRangesConfiguration:
    ...
    def test_healthy_ranges_completeness(self):
        ...
        required_nutrients = ["calories", "protein", "total_fat", "saturated_fat", "sugar", "sodium", "carbs"]
    ...
    def test_nutrient_weights_completeness(self):
        ...
        expected_nutrients = ["calories", "protein", "total_fat", "saturated_fat", "sugar", "sodium", "carbs"]
...
class TestRealWorldScenarios:
    ...
    def test_kaggle_dataset_simulation(self):
        ...
        df = pd.DataFrame(
            {
                "name": ["Chocolate Chip Cookies", "Caesar Salad", "Beef Stew", "Fruit Smoothie", "Pizza Margherita"],
                "nutrition": [
        ...
        _caesar_score = result[result["name"] == "Caesar Salad"]["nutrition_score"].iloc[0]
...
class TestComprehensiveIntegration:
    ...
    def test_consistency_across_runs(self, sample_nutrition_dataframe):
        ...
        pd.testing.assert_series_equal(result1["nutrition_score"], result2["nutrition_score"])
        pd.testing.assert_series_equal(result1["nutrition_grade"], result2["nutrition_grade"])
