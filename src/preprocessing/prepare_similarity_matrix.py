...
def load_recipe_data(file_path: str = "RAW_recipes.csv", 
                    local_data_dir: str = "data") -> pd.DataFrame:
    """
...
def create_feature_vectors(df: pd.DataFrame, 
                          ...
                          ease_weight: float = 5.0) -> Tuple[csr_matrix, Dict[str, Any]]:
    """
...
def save_preprocessed_data(combined_features: csr_matrix,
                          id_to_index: Dict[Any, int],
                          index_to_id: Dict[int, Any],
